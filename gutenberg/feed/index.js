( function( wp ) {
	...
	const { RadioControl, ToggleControl, SelectControl, PanelBody } = wp.components;
	...
	registerBlockType( 'wpboiler-core/feed', {
		...
		edit: function(props) {
			...
			const onChangeDoubleMarginsSelect = () => setAttributes({ doubleMargins: doubleMargins ? false : true });
					...
					el(
						...
						el(
							ToggleControl,
							{
								...
								onChange: onChangeDoubleMarginsSelect
							}
						)
					),
				),
